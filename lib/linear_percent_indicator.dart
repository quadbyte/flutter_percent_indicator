...
class LinearPercentIndicator extends StatefulWidget {
  ...
  final double? widgetIndicatorHorizontalOffset;
  final double? widgetIndicatorVerticalOffset;
  ...
  LinearPercentIndicator({
    ...
    this.widgetIndicatorHorizontalOffset,
    this.widgetIndicatorVerticalOffset,
  }) : super(key: key) {
...
class LinearPainter extends CustomPainter {
  ...
  LinearPainter({
    ...
    _paintLine.color =
        progress.toString() == "0.0" ? progressColor.withOpacity(0.0) : progressColor;
  ...
  Shader _createGradientShaderLeftToRight(Size size, double xProgress) {
    Offset shaderEndPoint =
        clipLinearGradient ? Offset(size.width, size.height) : Offset(xProgress, size.height);
    return linearGradient!.createShader(
      Rect.fromPoints(
        Offset.zero,
        shaderEndPoint,
